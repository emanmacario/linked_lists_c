/* Linked list structure definitions and functions.
 * Code taken from 'Programming, Problem Solving, and
 * Abstraction with C (Revised Edition)' written by Alistair Moffat.
 */
